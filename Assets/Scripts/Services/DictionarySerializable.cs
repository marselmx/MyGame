...
//<summary> Класс позволяющий реализовывать словари коллекций в редакторе </summary> 
[Serializable, DebuggerDisplay("Count = {Count}")]
public class DictionarySerializable<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    public DictionarySerializable(IDictionary<TKey, TValue> dictionary)
        : this(dictionary, null)
    {
    }
 
    public DictionarySerializable(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
   ...
   public ICollection<TValue> Values
   {
    ...
    {
        private readonly DictionarySerializable<TKey, TValue> _Dictionary;
    ...
    #if UNITY_EDITOR
    public abstract class DictionarySerializableEditor : PropertyDrawer
    {
        private DictionarySerializable<TKey, TValue> _Dictionary;
